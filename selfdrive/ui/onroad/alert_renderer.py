...
# Constants
ALERT_COLORS = {
  AlertStatus.normal: rl.Color(0x15, 0x15, 0x15, 0x80),      # #151515 with alpha 0x80
  AlertStatus.userPrompt: rl.Color(0xDA, 0x6F, 0x25, 0x99),  # #DA6F25 with alpha 0x99
  AlertStatus.critical: rl.Color(0xC9, 0x22, 0x31, 0x99),    # #C92231 with alpha 0x99
}
