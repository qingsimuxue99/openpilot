...
struct CarrotMan {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(81c2f05a394cf4af, 15, 9)
    #if !CAPNP_LITE
...
struct AmapNavi {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(aedffd8f31e7b55d, 3, 0)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
inline  ::int32_t CarrotMan::Reader::getLeftBlind() const {
  return _reader.getDataField< ::int32_t>(
      ::capnp::bounded<28>() * ::capnp::ELEMENTS);
}

inline  ::int32_t CarrotMan::Builder::getLeftBlind() {
  return _builder.getDataField< ::int32_t>(
      ::capnp::bounded<28>() * ::capnp::ELEMENTS);
}
inline void CarrotMan::Builder::setLeftBlind( ::int32_t value) {
  _builder.setDataField< ::int32_t>(
      ::capnp::bounded<28>() * ::capnp::ELEMENTS, value);
}

inline  ::int32_t CarrotMan::Reader::getRightBlind() const {
  return _reader.getDataField< ::int32_t>(
      ::capnp::bounded<29>() * ::capnp::ELEMENTS);
}

inline  ::int32_t CarrotMan::Builder::getRightBlind() {
  return _builder.getDataField< ::int32_t>(
      ::capnp::bounded<29>() * ::capnp::ELEMENTS);
}
inline void CarrotMan::Builder::setRightBlind( ::int32_t value) {
  _builder.setDataField< ::int32_t>(
