...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"CarrotLearningEnabled", PERSISTENT},
    {"CarrotLearningRate", PERSISTENT},
    {"CarrotLearningReset", PERSISTENT},
    {"CarrotLearningCurve", PERSISTENT},
    {"CarrotLearningSteer", PERSISTENT},
    {"CarrotLearningStatus", PERSISTENT},
    {"CarrotLearningReview", PERSISTENT},
    {"CarrotLearningApplyList", CLEAR_ON_MANAGER_START},
    {"CarrotLearningRevertList", CLEAR_ON_MANAGER_START},
    {"CarrotLearningDeleteList", CLEAR_ON_MANAGER_START},
    ...
    {"CarrotAiApplyList", CLEAR_ON_MANAGER_START},
    {"CarrotAiCloudKey", PERSISTENT},
    {"CarrotAiCloudRun", PERSISTENT},
    {"CarrotAiReportAuto", PERSISTENT},
    {"CarrotAiReportRun", PERSISTENT},
    {"CarrotAiRevertList", CLEAR_ON_MANAGER_START},
