...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"TrafficLightBrakeMode", PERSISTENT},
    {"TrafficLightBrakeMargin", PERSISTENT},
    {"TrafficLightBrakeConfirm", PERSISTENT},
    {"TrafficLightBrakeDecel", PERSISTENT},
    {"LaunchSmoothingMode", PERSISTENT},
    {"LaunchSmoothingInit", PERSISTENT},
    {"TrafficJamCreepMode", PERSISTENT},
    ...
    {"HazardBrakeMode", PERSISTENT},
    {"ComfortLongMode", PERSISTENT},
    {"LongAccelSmoothDown", PERSISTENT},
    {"LongAccelSmoothUp", PERSISTENT},
    {"LongJerkMax", PERSISTENT},
    {"LongJerkGain", PERSISTENT},
    {"LongJerkMinBound", PERSISTENT},
    {"HazardBrakeAccel", PERSISTENT},
    {"HazardBrakeRelease", PERSISTENT},
    {"HazardBrakeMinSpeed", PERSISTENT},
    {"HazardBrakeHold", PERSISTENT},
    {"HazardBrakeConfirm", PERSISTENT},
    {"BeepMode", PERSISTENT},
    ...
    {"AutoLaneChangeMinSpeed", PERSISTENT},
    ...
    {"CarrotActUsed", PERSISTENT},
    {"CarrotActivationCode", PERSISTENT},
    {"CarrotFanFullSpeed", CLEAR_ON_MANAGER_START},
    {"CarrotFreeCounted", CLEAR_ON_MANAGER_START},
    {"CarrotFreeUsed", PERSISTENT},
    {"CarrotLicRemain", PERSISTENT},
    {"CarrotLicStatus", PERSISTENT},
    {"CarrotSshShow", PERSISTENT},
    {"CarrotWideCamMode", PERSISTENT},
    {"CarrotWideCamSpeedHigh", PERSISTENT},
    {"CarrotWideCamSpeedLow", PERSISTENT},
    {"DynamicTFollowCutOut", PERSISTENT},
    {"TFollowGap1Base", PERSISTENT},
    {"TFollowGap2Base", PERSISTENT},
    ...
    {"CarrotScreenRecAutoStart", PERSISTENT},
    {"SameSpiCamFilter", PERSISTENT},
    {"StockBlinkerCtrl", PERSISTENT},
    {"ExtBlinkerCtrlTest", PERSISTENT},
    {"BlinkerMode", PERSISTENT},
    {"BlinkerTurnIntent", PERSISTENT},
    {"BlinkerTurnIntentSpeed", PERSISTENT},
    {"BlinkerTurnIntentFirm", PERSISTENT},
    {"BlinkerTurnIntentFirmGain", PERSISTENT},
    {"BlinkerTurnIntentFirmMax", PERSISTENT},
    {"BlinkerTurnIntentFirmMin", PERSISTENT},
    {"BlinkerTurnIntentFirmMaxAngle", PERSISTENT},
    ...
    {"AutoForkDistOffsetH", PERSISTENT},
    {"AutoEnTurnNewLaneTimeH", PERSISTENT},
    {"AutoDoForkDecalDistH", PERSISTENT},
    {"AutoDoForkDecalDist", PERSISTENT},
    {"AutoDoForkCheckDistH", PERSISTENT},
    {"AutoDoForkBlinkerDistH", PERSISTENT},
    {"AutoDoForkNavDistH", PERSISTENT},
    {"AutoForkDecalRateH", PERSISTENT},
    {"AutoForkSpeedMinH", PERSISTENT},
    {"AutoKeepForkSpeedH", PERSISTENT},
    {"AutoForkDecalRate", PERSISTENT},
    {"AutoForkSpeedMin", PERSISTENT},
    {"AutoKeepForkSpeed", PERSISTENT},
    {"AutoForkDistOffset", PERSISTENT},
    {"AutoEnTurnNewLaneTime", PERSISTENT},
    {"AutoDoForkCheckDist", PERSISTENT},
    {"AutoDoForkBlinkerDist", PERSISTENT},
    {"AutoDoForkNavDist", PERSISTENT},
