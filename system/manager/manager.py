...
def get_default_params():
  default_params : list[tuple[str, str | bytes]] = [
    ...
    ("UseLaneLineSpeed", "0"),
    ("PathOffset", "0"),
    ("AutoLaneCorrection", "2"),
    ("AutoLaneCorrectionGain", "40"),
    ("AutoLaneCorrectionLearned", "0"),
    ("CarrotLearningEnabled", "0"),
    ("CarrotLearningRate", "5"),
    ("CarrotLearningReset", "0"),
    ("CarrotLearningCurve", "1"),
    ("CarrotLearningSteer", "1"),
    ("CarrotLearningStatus", "未开始学习"),
    ...
    ("AutoForkDistOffsetH", "1500"),
    ("AutoEnTurnNewLaneTimeH", "3"),
    ("AutoDoForkDecalDistH", "100"),
    ("AutoDoForkDecalDist", "20"),
    ("AutoDoForkCheckDistH", "20"), #未使用
    ("AutoDoForkBlinkerDistH", "30"),
    ("AutoDoForkNavDistH", "80"),
    ...
    ("AutoEnTurnNewLaneTime", "1"),
    ("AutoDoForkCheckDist", "10"), #未使用
