...
from openpilot.selfdrive.ui.sunnypilot.layouts.settings.features import FeaturesLayout
...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    self._panels = {
      ...
      OP.PanelType.FEATURES: PanelInfo(tr("功能"), FeaturesLayout(), icon="icons/road.png"),
