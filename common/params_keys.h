...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"MeetYieldMode", PERSISTENT},
    {"MeetYieldOffset", PERSISTENT},
    {"MeetYieldDist", PERSISTENT},
    {"MeetYieldVRel", PERSISTENT},
    {"MeetYieldConfirm", PERSISTENT},
    {"MeetYieldRate", PERSISTENT},
    {"MeetYieldDir", PERSISTENT},
